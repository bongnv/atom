...
exports.normalizeKeystrokes = function (keystrokes) {
  ...
  for (var keystroke of keystrokes.split(WHITESPACE_REGEX)) {
...
exports.keystrokeForKeyboardEvent = function (event, customKeystrokeResolvers) {
  ...
  if (customKeystrokeResolvers != null) {
    for (var resolver of customKeystrokeResolvers) {
...
var buildKeyboardEvent = function (
  key,
  eventType,
  { ctrl, shift, alt, cmd, keyCode, target, location } = {}
) {
