...
`);
  ...
  it('autcompletes tag names without a prefix', () => {
    ...
    expect(completions[0].description).toContain(
      'Creates a hyperlink to other web pages'
    );
    expect(completions[0].descriptionMoreURL.endsWith('/HTML/Element/a')).toBe(
      true
    );
  ...
  it('autocompletes tag names with a prefix', () => {
    ...
    expect(
      completions[0].descriptionMoreURL.endsWith('/HTML/Element/datalist')
    ).toBe(true);
  ...
  it('autocompletes attribute names without a prefix', () => {
    ...
    expect(
      completions[0].descriptionMoreURL.endsWith(
    ...
    expect(
      completions[0].descriptionMoreURL.endsWith(
        '/HTML/Element/marquee#attr-align'
      )
    ).toBe(true);
  ...
  it('autocompletes attribute values without a prefix', () => {
    ...
    expect(
      completions[0].descriptionMoreURL.endsWith(
        '/HTML/Element/marquee#attr-behavior'
      )
    ).toBe(true);
  ...
  it('autocompletes ambiguous attribute values', () => {
    ...
    expect(completions[0].description.length).toBeGreaterThan(0);
    expect(
      completions[0].descriptionMoreURL.endsWith('/HTML/Element/link#attr-rel')
    ).toBe(true);
  });
