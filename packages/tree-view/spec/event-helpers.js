 ...
 */
module.exports.buildInternalDragEvents = function (
  dragged,
  enterTarget,
  dropTarget,
  treeView,
...
module.exports.buildExternalDropEvent = function (
  filePaths,
  dropTarget,
  copy = false
) {
...
const buildElementPositionalDragEvents = function (
  el,
  dataTransfer,
  ...
  const currentTarget = currentTargetSelector
    ? el.closest(currentTargetSelector)
    : el;
  ...
  Object.defineProperty(topEvent, 'pageY', {
  ...
  Object.defineProperty(middleEvent, 'pageY', {
    value: el.getBoundingClientRect().top + el.offsetHeight * 0.5,
  });
  ...
  Object.defineProperty(bottomEvent, 'pageY', {
    value: el.getBoundingClientRect().bottom,
  });

  return { top: topEvent, middle: middleEvent, bottom: bottomEvent };
};

module.exports.buildPositionalDragEvents = function (
  dragged,
  target,
  currentTargetSelector
) {
  ...
  return [
    dragStartEvent,
    buildElementPositionalDragEvents(
      target,
      dataTransfer,
      currentTargetSelector
    ),
