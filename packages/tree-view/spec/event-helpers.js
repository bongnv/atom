 ...
 */
module.exports.buildInternalDragEvents = function(dragged, enterTarget, dropTarget, treeView, copy = false) {
  const dataTransfer = {
    data: {},
...
module.exports.buildExternalDropEvent = function(filePaths, dropTarget, copy = false) {
  const dataTransfer = {
    data: {},
    setData(key, value) { return this.data[key] = `${value}`; }, // Drag events stringify data values
    getData(key) { return this.data[key]; },
