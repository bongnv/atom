    ...
    this.disposables.add(
      atom.commands.add('atom-workspace', {
        ...
        'tree-view:toggle-focus': () =>
          this.getTreeViewInstance().toggleFocus(),
        ...
        'tree-view:duplicate': () =>
          this.getTreeViewInstance().copySelectedEntry(),
        'tree-view:remove': () =>
          this.getTreeViewInstance().removeSelectedEntries(),
        'tree-view:rename': () =>
          this.getTreeViewInstance().moveSelectedEntry(),
  ...
  provideTreeView() {
    return {
      ...
      entryForPath: (entryPath) =>
        this.getTreeViewInstance().entryForPath(entryPath),
    };
  }
