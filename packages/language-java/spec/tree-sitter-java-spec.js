  ...
  const getTokens = function (buffer, row) {
    ...
    while (true) {
      ...
      if (end.column < line.length) {
        for (var num of iterator.getCloseScopeIds()) {
          var item = scopes.pop();
        }
    ...
    return (() => {
      ...
      for (let i = 0; i < tokens.length; i++) {
        ...
        for (var j = 0; j < token.length; j++) {
          var t = token[j];
          var scopes = t.scopes.map((scope) => `'${scope}'`).join(', ');
          console.log(
...
`);
    ...
    return expect(tokens[5][1]).toEqual({
      value: '!=',
      scopes: ['source.java', 'keyword.operator.comparison'],
    });
  });
...
`);
    ...
    return expect(tokens[11][0]).toEqual({
      value: '--',
      scopes: ['source.java', 'keyword.operator.arithmetic'],
    });
  });
...
`);
    ...
    return expect(tokens[12][0]).toEqual({
      value: '~',
      scopes: ['source.java', 'keyword.operator.bitwise'],
    });
  });
...
`);
    ...
    expect(tokens[1][3]).toEqual({
      value: 'true',
      scopes: ['source.java', 'constant.boolean'],
    });
    ...
    return expect(tokens[14][3]).toEqual({
      value: '"abc"',
...
`);
    ...
    return expect(tokens[10][5]).toEqual({
      value: 'A1_B2_C3',
      scopes: ['source.java', 'constant.other'],
    });
  });
...
`);
    ...
    return expect(tokens[6][3]).toEqual({
      value: 'C$_STR$_DEF$',
      scopes: ['source.java', 'constant.other'],
    });
  });
  ...
  it('tokenizes reserved keywords', function () {
    ...
    expect(tokens[0]).toEqual({
      value: 'const',
      scopes: ['source.java', 'keyword.reserved'],
    });
  ...
  it('tokenizes packages', function () {
    ...
    expect(tokens[1]).toEqual({
      value: ' com',
      scopes: ['source.java', 'meta.package'],
    });
    expect(tokens[2]).toEqual({
      value: '.',
...
`);
    ...
    return expect(tokens[1][1]).toEqual({
      value: 'synchronized',
      scopes: ['source.java', 'meta.class.body', 'storage.modifier'],
    });
  });
...
`);
    ...
    expect(tokens[0][4]).toEqual({
      value: 'Tpe',
      scopes: ['source.java', 'storage.type'],
    });
    expect(tokens[1][2]).toEqual({
      value: 'instanceof',
      scopes: ['source.java', 'keyword.operator.instanceof'],
    ...
    return expect(tokens[5][4]).toEqual({
      value: 'instanceof',
      scopes: ['source.java', 'keyword.operator.instanceof'],
    });
  });
  ...
  it('tokenizes ternary', function () {
    ...
    expect(tokens[6]).toEqual({
      value: '?',
      scopes: ['source.java', 'keyword.control.ternary'],
    });
...
`);
    ...
    expect(tokens[1][1]).toEqual({
      value: 'try',
      scopes: ['source.java', 'keyword.control'],
    });
    expect(tokens[3][3]).toEqual({
      value: 'catch',
      scopes: ['source.java', 'keyword.control'],
    ...
    return expect(tokens[4][5]).toEqual({
      value: 'Exception3',
      scopes: ['source.java', 'storage.type'],
    });
  });
  ...
  it('tokenizes spread parameters', function () {
    ...
    expect(tokens[5]).toEqual({
      value: '/* ... */',
      scopes: ['source.java', 'comment.block'],
    });
...
`);
  ...
  it('tokenizes this and super', function () {
    ...
    expect(tokens[0]).toEqual({
      value: 'this',
      scopes: ['source.java', 'variable.language'],
    });
    return expect(tokens[5]).toEqual({
      value: 'super',
      scopes: ['source.java', 'variable.language'],
...
`);
    ...
    return expect(tokens[4][3]).toEqual({
      value: 'super',
      scopes: [
        'source.java',
        'meta.class.body',
...
`);
    ...
    return expect(tokens[9][7]).toEqual({
      value: 'T',
      scopes: ['source.java', 'meta.class.body', 'meta.method', 'storage.type'],
    });
  });
...
`);
    ...
    return expect(tokens[2][8]).toEqual({
      value: ')',
      scopes: [
        'source.java',
        'meta.class.body',
...
`);
    ...
    return expect(tokens[7][22]).toEqual({
      value: '>',
      scopes: ['source.java', 'punctuation.bracket.angle'],
    });
  });
...
`);
    ...
    return expect(tokens[14][16]).toEqual({
      value: '>',
      scopes: [
        'source.java',
        'meta.class.body',
...
`);
    ...
    return expect(tokens[14][9]).toEqual({
      value: '<',
      scopes: [
        'source.java',
        'meta.class.body',
...
`);
    ...
    return expect(tokens[3][10]).toEqual({
      value: '>',
      scopes: ['source.java', 'meta.class.body', 'punctuation.bracket.angle'],
    });
  });
  ...
  it('tokenizes classes', function () {
    ...
    expect(tokens[6]).toEqual({
      value: 'class',
      scopes: ['source.java', 'keyword.other.class'],
    });
...
`);
    ...
    expect(tokens[0][2]).toEqual({
      value: 'enum',
      scopes: ['source.java', 'keyword.other.enum'],
    });
    expect(tokens[0][4]).toEqual({
      value: 'A',
    ...
    return expect(tokens[5][0]).toEqual({
      value: '}',
      scopes: ['source.java', 'meta.enum.body', 'punctuation.bracket.curly'],
    });
  });
...
`);
    ...
    expect(tokens[3][3]).toEqual({
      ...
      scopes: [
        'source.java',
        'meta.declaration.annotation',
        'variable.other.annotation.element',
      ],
    });
    expect(tokens[3][5]).toEqual({
      value: '=',
    ...
    return expect(tokens[5][5]).toEqual({
      value: ')',
      scopes: [
        'source.java',
        'meta.declaration.annotation',
...
`);
    ...
    return expect(tokens[11][1]).toEqual({
      value: '}',
      scopes: [
        'source.java',
        'meta.class.body',
...
`);
    ...
    return expect(tokens[12][5]).toEqual({
      value: 'func',
      scopes: [
        'source.java',
        'meta.class.body',
...
`);
    ...
    return expect(tokens[6][1]).toEqual({
      value: 'Arrays',
      scopes: [
        'source.java',
        'meta.class.body',
