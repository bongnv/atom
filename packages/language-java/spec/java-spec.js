...
`);
  ...
  it('tokenizes the `package` keyword', function () {
    ...
    expect(tokens[1]).toEqual({
      value: ' ',
      scopes: ['source.java', 'meta.package.java'],
    });
    expect(tokens[2]).toEqual({
      value: 'java',
      scopes: [
  ...
  it('tokenizes the `import` keyword', function () {
    ...
    expect(tokens[1]).toEqual({
      value: ' ',
      scopes: ['source.java', 'meta.import.java'],
    });
    expect(tokens[2]).toEqual({
      value: 'java',
      scopes: [
  ...
  it('tokenizes reserved keywords', function () {
    ...
    expect(tokens[0]).toEqual({
      value: 'const',
      scopes: ['source.java', 'keyword.reserved.java'],
    });
...
`);
    ...
    return expect(lines[17][2]).toEqual({
      value: 'A$B',
      scopes: [
        'source.java',
        'meta.class.java',
...
`);
    ...
    const commentJavadoc = [
      'source.java',
      'meta.enum.java',
      'comment.block.javadoc.java',
    ];
    const commentDefinition = comment.concat(
      'punctuation.definition.comment.java'
    );
    const commentLineDefinition = commentLine.concat(
      'punctuation.definition.comment.java'
    );
    const commentJavadocDefinition = commentJavadoc.concat(
      'punctuation.definition.comment.java'
    );
    ...
    expect(lines[7][1]).toEqual({
      value: '/**',
      scopes: commentJavadocDefinition,
    });
    expect(lines[7][2]).toEqual({
      value: ' Javadoc comment about C ',
      scopes: commentJavadoc,
    });
    expect(lines[8][1]).toEqual({
      value: 'C',
      scopes: ['source.java', 'meta.enum.java', 'constant.other.enum.java'],
    });
    return expect(lines[9][0]).toEqual({
      value: '}',
      scopes: [
        'source.java',
        'meta.enum.java',
...
`);
    ...
    return expect(lines[22][0]).toEqual({
      value: '}',
      scopes: [
        'source.java',
        'meta.enum.java',
...
`);
    ...
    expect(lines[9][0]).toEqual({
      value: 'unknown ',
      scopes: ['source.java', 'meta.enum.java'],
    });
    return expect(lines[9][1]).toEqual({
      value: 'enum',
      scopes: ['source.java', 'meta.enum.java', 'storage.modifier.java'],
    });
  });
...
`);
    ...
    return expect(lines[15][3]).toEqual({
      value: 'func',
      scopes: [
        'source.java',
        'meta.enum.java',
...
`);
    ...
    return expect(lines[27][0]).toEqual({
      value: '}',
      scopes: [
        'source.java',
        'meta.enum.java',
...
`);
    ...
    return expect(lines[16][7]).toEqual({
      value: 'SomeInterface',
      scopes: scopeStack.concat([
        'meta.definition.class.implemented.interfaces.java',
        'entity.other.inherited-class.java',
  ...
  it('does not catastrophically backtrack when tokenizing large enums (regression)', function () {
    ...
    const enumContents =
      'AAAAAAAAAAA, BBBBBBBBBB, CCCCCCCCCC, DDDDDDDDDD, EEEEEEEEEE, FFFFFFFFFF, '.repeat(
        50
      );
...
`);
    ...
    return expect(lines[25][26]).toEqual({
      value: ')',
      scopes: scopeStack.concat([
        'meta.method.identifier.java',
        'punctuation.definition.parameters.end.bracket.round.java',
...
`);
    ...
    return expect(lines[6][16]).toEqual({
      value: '...',
      scopes: [
        'source.java',
        'meta.class.java',
...
`);
    ...
    return expect(lines[3][7]).toEqual({
      value: 'bfinal',
      scopes: [
        'source.java',
        'meta.class.java',
...
`);
    ...
    return expect(lines[6][7]).toEqual({
      value: '5',
      scopes: [
        'source.java',
        'meta.class.java',
...
`);
    ...
    return expect(lines[2][8]).toEqual({
      value: 'd',
      scopes: [
        'source.java',
        'meta.class.java',
...
`);
    ...
    return expect(lines[6][19]).toEqual({
      value: ')',
      scopes: ['source.java', 'punctuation.bracket.round.java'],
    });
  });
...
`);
    ...
    return expect(lines[8][11]).toEqual({
      value: ';',
      scopes: [
        'source.java',
        'meta.class.java',
...
`);
    ...
    return expect(lines[12][4]).toEqual({
      value: ';',
      scopes: [
        'source.java',
        'meta.class.java',
...
`);
    ...
    expect(lines[0][10]).toEqual({
      ...
      scopes: [
        'source.java',
        'meta.class.java',
        'punctuation.separator.types.java',
      ],
    });
    ...
    return expect(lines[8][13]).toEqual({
      value: 'set2',
      scopes: [
        'source.java',
        'meta.class.java',
...
`);
    ...
    return expect(lines[5][10]).toEqual({
      value: ';',
      scopes: ['source.java', 'punctuation.terminator.java'],
    });
  });
...
`);
    ...
    return expect(lines[2][10]).toEqual({
      value: '<',
      scopes: ['source.java', 'keyword.operator.comparison.java'],
    });
  });
...
`);
    ...
    return expect(lines[5][15]).toEqual({
      value: '>',
      scopes: ['source.java', 'punctuation.bracket.angle.java'],
    });
  });
...
`);
    ...
    return expect(lines[2][14]).toEqual({
      value: ';',
      scopes: [
        'source.java',
        'meta.class.java',
  ...
  it('tokenizes `new` statements', function () {
    ...
    ({ tokens } = grammar.tokenizeLine(
      'boolean[] list = new boolean[variable];'
    ));
    ...
    ({ tokens } = grammar.tokenizeLine(
      'String[] list = new String[]{"hi", "abc", "etc"};'
    ));
...
`);
    ...
    ({ tokens } = grammar.tokenizeLine(
      'String a = (valid ? new Date().toString() + " : " : "");'
    ));
    ...
    ({ tokens } = grammar.tokenizeLine(
      'String[] list = new String[variable];'
    ));
    ...
    ({ tokens } = grammar.tokenizeLine(
      'Point point = true ? new Point(1, 4) : new Point(0, 0);'
    ));
    ...
    ({ tokens } = grammar.tokenizeLine(
      'map.put(key, new Value(value), "extra");'
    ));
    ...
    expect(tokens[11]).toEqual({
      value: ' ',
      scopes: ['source.java', 'meta.inner-class.java'],
    });
    expect(tokens[12]).toEqual({
      value: '}',
      scopes: [
...
`);
    ...
    return expect(lines[6][4]).toEqual({
      value: 'instanceof',
      scopes: scopeStack.concat([
...
`);
    ...
    return expect(lines[10][7]).toEqual({
      value: 'instanceof',
      scopes: expected,
    });
  });
...
`);
    ...
    return expect(lines[17][7]).toEqual({
      value: 'var2',
      scopes: [
        'source.java',
        'meta.class.java',
...
`);
    ...
    return expect(lines[6][3]).toEqual({
      value: 'abcd',
      scopes: scopeStack.concat([
        'meta.method.java',
        'meta.method.identifier.java',
...
`);
    ...
    return expect(lines[5][7]).toEqual({
      value: ']',
      scopes: [
        'source.java',
        'meta.class.java',
...
`);
    ...
    return expect(lines[3][9]).toEqual({
      value: '_String',
      scopes: [
        'source.java',
        'meta.class.java',
...
`);
    ...
    scopeStack.pop();
    return expect(lines[11][1]).toEqual({
      value: '}',
      scopes: scopeStack.concat([
        'punctuation.section.finally.end.bracket.curly.java',
      ]),
    });
  });
...
`);
    ...
    return expect(lines[8][12]).toEqual({
      value: '}',
      scopes: scopeStack.concat([
        'punctuation.section.catch.end.bracket.curly.java',
      ]),
...
`);
    ...
    return expect(lines[2][22]).toEqual({
      value: '{',
      scopes: scopes.concat([
        'punctuation.section.try.begin.bracket.curly.java',
      ]),
...
`);
    ...
    return expect(lines[5][11]).toEqual({
      value: ')',
      scopes: [
        'source.java',
        'meta.class.java',
...
`);
    ...
    return expect(lines[8][6]).toEqual({
      value: ')',
      scopes: [
        'source.java',
        'meta.class.java',
...
`);
    ...
    return expect(lines[5][31]).toEqual({
      value: ')',
      scopes: [
        'source.java',
        'meta.class.java',
...
`);
    ...
    return expect(lines[5][13]).toEqual({
      value: '{',
      scopes: [
        'source.java',
        'meta.class.java',
...
`);
    ...
    return expect(lines[8][2]).toEqual({
      value: '*/',
      scopes: [
        'source.java',
        'comment.block.java',
...
`);
    ...
    return expect(lines[8][10]).toEqual({
      value: ')',
      scopes: [
        'source.java',
        'meta.class.java',
...
`);
    ...
    return expect(lines[9][14]).toEqual({
      value: 'chars()',
      scopes: [
        'source.java',
        'meta.class.java',
...
`);
    ...
    return expect(lines[8][5]).toEqual({
      value: 'Test',
      scopes: [
        'source.java',
        'meta.declaration.annotation.java',
...
`);
    ...
    return expect(lines[0][18]).toEqual({
      value: '}',
      scopes: recordScopes.concat([
        'punctuation.section.class.end.bracket.curly.java',
      ]),
...
`);
    ...
    return expect(lines[0][15]).toEqual({
      value: '}',
      scopes: recordScopes.concat([
        'punctuation.section.class.end.bracket.curly.java',
      ]),
...
`);
    ...
    const methodScopes = recordScopes.concat([
      'meta.record.body.java',
      'meta.method.java',
    ]);
    expect(lines[1][1]).toEqual({
