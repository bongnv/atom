...
module.exports = class FindView {
    ...
    this.subscriptions.add(
      atom.commands.add('atom-workspace', {
        ...
        'find-and-replace:find-previous-selected':
          this.findPreviousSelected.bind(this),
        'find-and-replace:use-selection-as-find-pattern':
          this.setSelectionAsFindPattern.bind(this),
  ...
  confirm() {
    this.findNext({
      focusEditorAfter: atom.config.get(
        'find-and-replace.focusEditorAfterSearch'
      ),
    });
  }
  ...
  liveSearch() {
    ...
    if (
      ...
      (findPattern.length >=
        atom.config.get('find-and-replace.liveSearchMinimumCharacters') &&
  ...
  selectAllMarkers() {
    ...
    const ranges = Array.from(this.markers).map((marker) =>
