...
describe('CheckSuitesAccumulator', function () {
  ...
  it('recursively renders a CheckRunsAccumulator for each check suite', function () {
    ...
    const runsWrapper1 = accumulator1.renderProp('children')({
      error: null,
      checkRuns: [4, 5, 6],
      loading: false,
    });
