...
export const RepositoryConnectionBuilder = createConnectionBuilderClass(
  'Repository',
  RepositoryBuilder
);

export const OrganizationConnectionBuilder = createConnectionBuilderClass(
  'Organization',
  DeferredOrganizationBuilder
);

export const UserBuilder = createSpecBuilderClass(
  'User',
  {
    ...
    avatarUrl: {
      default: 'https://avatars3.githubusercontent.com/u/17565?s=32&v=4',
    },
    url: {
      default: (f) => {
...
export const OrganizationMemberConnectionBuilder = createConnectionBuilderClass(
  'OrganizationMember',
  UserBuilder
);

export const OrganizationBuilder = createSpecBuilderClass(
  'Organization',
  {
...
export const RepositoryOwnerBuilder = createUnionBuilderClass(
  'RepositoryOwner',
  {
    beUser: UserBuilder,
