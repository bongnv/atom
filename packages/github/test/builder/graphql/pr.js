...
export const PullRequestCommitBuilder = createSpecBuilderClass(
  'PullRequestCommit',
  {
    id: { default: nextID },
...
export const PullRequestTimelineItemsBuilder = createUnionBuilderClass(
...
export const CommentBuilder = createSpecBuilderClass(
  'PullRequestReviewComment',
  {
    ...
    reactionGroups: {
      linked: ReactionGroupBuilder,
      plural: true,
      singularName: 'reactionGroup',
    },
    url: {
      default: 'https://github.com/atom/github/pull/1829/files#r242224689',
    },
    createdAt: { default: '2018-12-27T17:51:17Z' },
    lastEditedAt: { default: null, nullable: true },
    body: {
      default: 'Lorem ipsum dolor sit amet, te urbanitas appellantur est.',
    },
    bodyHTML: {
      default: 'Lorem ipsum dolor sit amet, te urbanitas appellantur est.',
    },
...
export const ReviewBuilder = createSpecBuilderClass(
  'PullRequestReview',
  {
    ...
    url: {
      default:
        'https://github.com/atom/github/pull/1995#pullrequestreview-223120384',
    },
    body: {
      default:
...
export const CommitConnectionBuilder = createConnectionBuilderClass(
  'PullRequestCommit',
  CommentBuilder
);

export const PullRequestBuilder = createSpecBuilderClass(
  'PullRequest',
  {
    id: { default: nextID },
    ...
    url: {
      default: (f) => {
        const ownerLogin =
          (f.repository && f.repository.owner && f.repository.owner.login) ||
          'aaa';
    ...
    reviews: {
      linked: createConnectionBuilderClass('ReviewConnection', ReviewBuilder),
    },
    reviewThreads: {
      linked: createConnectionBuilderClass(
    ...
    timelineItems: {
      linked: createConnectionBuilderClass(
        'PullRequestTimelineItems',
        PullRequestTimelineItemsBuilder
      ),
    },
    reactionGroups: {
      linked: ReactionGroupBuilder,
