...
export const CheckRunBuilder = createSpecBuilderClass(
  'CheckRun',
  {
    ...
    detailsUrl: {
      default: 'https://pushbot.party/check-run/1234',
      nullable: true,
    },
  },
...
export const CheckRunConnection = createConnectionBuilderClass(
  'CheckRunConnection',
  CheckRunBuilder
);

export const AppBuilder = createSpecBuilderClass(
  'App',
  {
...
export const CheckSuiteBuilder = createSpecBuilderClass(
  'CheckSuite',
  {
...
export const CheckSuiteConnection = createConnectionBuilderClass(
  'CheckSuiteConnection',
  CheckSuiteBuilder
);

export const StatusContextBuilder = createSpecBuilderClass(
  'StatusContext',
  {
    id: { default: nextID },
...
export const StatusBuilder = createSpecBuilderClass(
  'Status',
  {
    id: { default: nextID },
    state: { default: 'SUCCESS' },
    contexts: {
      linked: StatusContextBuilder,
      plural: true,
...
export const CommitBuilder = createSpecBuilderClass(
  'Commit',
  {
    ...
    commitUrl: {
      default: (f) => {
        const sha =
          f.oid || f.sha || '0000000000000000000000000000000000000000';
...
export const CommitCommentBuilder = createSpecBuilderClass(
  'CommitComment',
  {
    id: { default: nextID },
    author: { linked: UserBuilder, default: null, nullable: true },
...
export const PullRequestCommitCommentThreadBuilder = createSpecBuilderClass(
  'PullRequestCommitCommentThread',
  {
    commit: { linked: CommitBuilder },
    comments: {
      linked: createConnectionBuilderClass(
        'CommitComment',
...
export const CrossReferencedEventBuilder = createSpecBuilderClass(
...
export const HeadRefForcePushedEventBuilder = createSpecBuilderClass(
...
export const IssueCommentBuilder = createSpecBuilderClass(
  'IssueComment',
  {
    author: { linked: UserBuilder, default: null, nullable: true },
...
export const MergedEventBuilder = createSpecBuilderClass(
  'MergedEvent',
  {
    actor: { linked: UserBuilder },
    commit: { linked: CommitBuilder },
