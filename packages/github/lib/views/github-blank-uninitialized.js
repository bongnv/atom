  ...
  return (
    <div className="github-Local-Uninit github-Blank">
      <main className="github-Blank-body">
        ...
        <p className="github-Blank-context">
        ...
        <p className="github-Blank-explanation">
          Create a new GitHub repository, then track the existing content within
          this directory as a git repository configured to push there.
        </p>
        <p className="github-Blank-footer github-Blank-explanation">
          To initialize this directory as a git repository without publishing it
          to GitHub, visit the
