      ...
      >
        <TabList className="github-tablist">
          <Tab className="github-tab">
            <Octicon icon="info" className="github-tab-icon" />
            Overview
          </Tab>
          <Tab className="github-tab">
          ...
          <Tab className="github-tab">
            <Octicon icon="git-commit" className="github-tab-icon" />
            Commits
          ...
          <Tab className="github-tab">
            <Octicon icon="diff" className="github-tab-icon" />
            Files
      ...
      (err) => {
        if (err) {
          this.props.reportRelayError(
            'Unable to refresh pull request details',
            err
          );
        }
