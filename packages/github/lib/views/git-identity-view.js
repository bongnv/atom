  ...
  render() {
    return (
      <div className="github-GitIdentity">
        <h1 className="github-GitIdentity-title">Git Identity</h1>
        <p className="github-GitIdentity-explanation">
          Please set the username and email address that you wish to use to
          author git commits. This will write to the
          <code>user.name</code> and <code>user.email</code> values in your git
          configuration at the chosen scope.
        </p>
