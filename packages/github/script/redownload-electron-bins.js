...
try {
  downloadMksnapshotPath = require.resolve(
...
if (typeof downloadMksnapshotPath !== 'undefined') {
  ...
  const electronVersion = fs.existsSync(atomRepoPath)
    ? require(atomRepoPath).electronVersion
    : '6.1.12';
  ...
  console.log(
    'devDependency "electron-mksnapshot/download-mksnapshot.js" not found.\nSkipping "redownload electron bins" script.\n'
  );
}
