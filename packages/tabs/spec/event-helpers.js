...
module.exports.buildDragEnterLeaveEvents = (
  enterRelatedTarget,
  leaveRelatedTarget
) => {
  const dataTransfer = {
  ...
  const dragEnterEvent = buildMouseEvent('dragenter', null, {
    relatedTarget: enterRelatedTarget,
  });
  ...
  const dragLeaveEvent = buildMouseEvent('dragleave', null, {
    relatedTarget: leaveRelatedTarget,
  });
