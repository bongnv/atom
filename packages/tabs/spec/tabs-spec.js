...
describe("TabBarView", function() {
  ...
  class TestView {
    ...
    emitTitleChanged() {
      return (this.titleCallbacks != null ? this.titleCallbacks : []).map((callback) => callback());
    }
    ...
    emitIconChanged() {
      return (this.iconCallbacks != null ? this.iconCallbacks : []).map((callback) => callback());
    }
  ...
  return describe("integration with version control systems", function() {
    ...
    beforeEach(function() {
      ...
      repository.emitDidChangeStatus = function(event) {
        return (this.changeStatusCallbacks != null ? this.changeStatusCallbacks : []).map((callback) => callback(event));
      };
      ...
      repository.emitDidChangeStatuses = function(event) {
        return (this.changeStatusesCallbacks != null ? this.changeStatusesCallbacks : []).map((callback) => callback(event));
      };
