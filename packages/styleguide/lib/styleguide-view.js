...
export default class StyleguideView {
  constructor(props) {
    this.uri = props.uri;
    this.collapsedSections = props.collapsedSections
      ? new Set(props.collapsedSections)
      : new Set();
    this.sections = [];
  ...
  serialize() {
    return {
      ...
      collapsedSections: this.sections
    ...
    return (
      <div className="styleguide pane-item native-key-bindings" tabIndex="-1">
        ...
        <main className="styleguide-sections">
          ...
          >
            <p>
              Use these UI variables in your package's stylesheets. They are set
              by UI themes and therefore your package will match the overall
              look. Make sure to @import 'ui-variables' in your stylesheets to
              use these variables.
            </p>
            <h2>Text colors</h2>
          ...
          >
            <p>
              Atom comes bundled with the Octicons. It lets you easily add icons
              to your packages.
            </p>
            <p>
              Currently version <code>4.4.0</code> is available. In addition
              some older icons from version <code>2.1.2</code> are still kept
              for backwards compatibility. Make sure to use the{' '}
              <code>icon icon-</code> prefix in front of an icon name. See the{' '}
          ...
          >
            ...
            <h2>.block</h2>
            <p>
              Sometimes you need to separate components vertically. Say in a
              form.
            </p>
            {this.renderExampleHTML(dedent`
              <div class='block'>
          ...
          >
            <p>
              Site colors are used for collaboration. A site is another
              collaborator.
            </p>

            <h2>ui-site-* classes</h2>
            <p>
              These classes only set the background color, no other styles. You
              can also use LESS variables <code>@ui-site-#</code> in your
              plugins where
          ...
          >
            ...
            <h2>Badge sizes</h2>
            <p>
              By default the <code>@font-size</code> variable from themes is
              used. Additionally there are also 3 predefined sizes.
            </p>
            {this.renderExampleHTML(dedent`
            ...
            <p>
              ...
              <code>badge-flexible</code> class. Note: Best used for larger
              sizes. For smaller sizes it could cause the number to be
              mis-aligned by a pixel.
            </p>
            {this.renderExampleHTML(dedent`
          ...
          >
            ...
            <p>
              Buttons can be marked selected by adding a <code>.selected</code>{' '}
              class. Useful for toggle groups.
            </p>
            {this.renderExampleHTML(dedent`
              <div class='block'>
                <div class='btn-group'>
          ...
          >
            <p>
              A <code>.list-tree</code> is a special case of{' '}
            ...
            <p>
              Add the class <code>.has-collapsable-children</code> to give the
              children with nested items disclosure arrows.
            </p>
            {this.renderExampleHTML(dedent`
            ...
            <p>
              Add the class <code>.has-flat-children</code> to sub-
              <code>.list-tree</code>s to indicate that the children will not be
              collapsable.
            </p>
            {this.renderExampleHTML(dedent`
              <ul class='list-tree has-collapsable-children '>
          ...
          >
            ...
            <p>
              The list items have many options you can use, and shows you how
              they will display.
            </p>
          ...
          >
            <p>
              ...
              . Passing in a <code>command</code> (like{' '}
              <code>find-and-replace:show-find</code>) and
              <code>commandElement</code> (context for the command) will yield a
              tip with a keystroke.
            </p>
          ...
          >
            ...
            <p>
              Subtle background messages for panes. Use for cases when there are
              no results.
            </p>
            ...
            <p>
              Centered background messages will center horizontally and
              vertically. Your container for this element must have{' '}
              <code>position</code> set with <code>relative</code> or
              <code>absolute</code>.
            </p>
