  ...
  describe('Provider API v2.0.0', () => {
    describe('common functionality', () => {
      ...
      it('correctly displays the suggestion options', async () => {
        ...
        expect(
          suggestionListView.element.querySelector('li .right-label')
        ).toHaveHtml('<span style="color: red">ohai</span>');
        expect(suggestionListView.element.querySelector('.word')).toHaveText(
          'ohai'
        );
        expect(
          suggestionListView.element.querySelector(
      ...
      it('correctly displays the suggestion description and More link', async () => {
        ...
        let suggestionListView =
          autocompleteManager.suggestionList.suggestionListElement;
        let content = suggestionListView.element.querySelector(
          '.suggestion-description-content'
        );
      ...
      it('it calls getSuggestionDetailsOnSelect if available and replaces suggestion', async () => {
        ...
        expect(autocompleteManager.suggestionList.items[0].description).toBe(
          'foo'
        );
      });
    });
