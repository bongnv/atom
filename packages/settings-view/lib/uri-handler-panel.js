...
function isDefaultProtocolClient() {
  return require('electron').remote.app.isDefaultProtocolClient(
    'atom',
    process.execPath,
    ['--uri-handler', '--']
  );
...
function setAsDefaultProtocolClient() {
  ...
  return (
    isSupported() &&
    require('electron').remote.app.setAsDefaultProtocolClient(
      'atom',
      process.execPath,
      ['--uri-handler', '--']
    )
...
export default class UriHandlerPanel {
  constructor() {
    ...
    this.handleBecomeProtocolClient =
      this.handleBecomeProtocolClient.bind(this);
