        ...
        <form className="general-panel section">
          <div className="settings-panel">
            <div className="section-container">
              <div className="block section-heading icon icon-device-desktop">
                System Settings
              </div>
              <div className="text icon icon-question">
                These settings determine how Atom integrates with your operating
                system.
              </div>
                    ...
                    <div className="checkbox">
                      <label for="system.windows.file-handler">
                        ...
                        <div className="setting-description">
                          Show {WinShell.appName} in the "Open with" application
                          list for easy association with file types.
                        </div>
                      </label>
                    </div>
                  </div>
                  ...
                  <div className="controls">
                    <div className="checkbox">
                      <label for="system.windows.shell-menu-files">
                        ...
                        <div className="setting-description">
                          Add "Open with {WinShell.appName}" to the File
                          Explorer context menu for files.
                        </div>
                      </label>
                    </div>
                  </div>
