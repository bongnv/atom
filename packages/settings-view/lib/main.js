...
module.exports = {
  ...
  consumeSnippets(snippets) {
    ...
    if (typeof snippets.getUserSnippetsPath === 'function') {
      SnippetsProvider.getUserSnippetsPath =
        snippets.getUserSnippetsPath.bind(snippets);
    }
  },
  ...
  showDeprecatedNotification(packages) {
    ...
    const notification = atom.notifications.addWarning(
      ...
      {
        description:
          'This message will show only one time. Deprecated packages can be viewed in the settings view.',
