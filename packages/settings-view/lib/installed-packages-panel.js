...
export default class InstalledPackagesPanel extends CollapsibleSectionPanel {
  ...
  constructor(settingsView, packageManager) {
    ...
    this.itemViews = {
      ...
      deprecated: new ListView(
        this.items.deprecated,
        this.refs.deprecatedPackages,
        this.createPackageCard.bind(this)
      ),
    };
      ...
      <div className="panels-item" tabIndex="-1">
        <section className="section">
          <div className="section-container">
            ...
            <section
              ref="deprecatedSection"
              className="sub-section deprecated-packages"
            >
              <h3
                ref="deprecatedPackagesHeader"
              ...
              <p>
                Atom does not load deprecated packages. These packages may have
                updates available.
              </p>
              <div
                ref="deprecatedPackages"
                className="container package-container"
              >
                <div
                  ref="deprecatedLoadingArea"
