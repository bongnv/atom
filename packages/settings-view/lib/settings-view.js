...
export default class SettingsView {
  ...
  getPackages () {
    ...
    try {
      ...
      const packageMetadata = require(/* webpackIgnore: true */path.join(atom.getLoadSettings().resourcePath, 'package.json'))
    ...
    for (const packageName of disabledPackages) {
      ...
      try {
        metadata = require(/* webpackIgnore: true */path.join(packagePath, 'package.json'))
      } catch (error) {
