...
describe('PackageUpdatesStatusView', function () {
  ...
  beforeEach(function () {
    ...
    return runs(function () {
      ...
      expect(
        document.querySelector('status-bar .package-updates-status-view')
      ).toExist();
  ...
  describe('when the tile is clicked', function () {
    it('opens the Available Updates panel', function () {
      ...
      return expect(atom.commands.dispatch).toHaveBeenCalledWith(
  ...
  return describe('when a package that failed to update is uninstalled', () =>
    it('updates the tile', function () {
      packageManager.emitPackageEvent('update-failed', outdatedPackage1);
      packageManager.emitPackageEvent('uninstalled', outdatedPackage1);
      return expect(
