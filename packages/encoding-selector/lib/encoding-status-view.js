...
module.exports = class EncodingStatusView {
  ...
  subscribeToActiveTextEditor() {
    ...
    if (editor) {
      this.encodingSubscription = editor.onDidChangeEncoding(
        this.updateEncodingText.bind(this)
      );
    }
  ...
  updateEncodingText() {
    atom.views.updateDocument(() => {
      ...
      if (editor && editor.getEncoding()) {
        ...
        const encodingLabel = this.encodings[editorEncoding] || {
          status: editorEncoding,
        };
