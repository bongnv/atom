...
describe('JSDoc grammar', function () {
  ...
  describe('inline tags', function () {
    ...
    it('tokenises tags with an embedded trailing description', function () {
      let { tokens } = grammar.tokenizeLine(
        '/** Text {@linkplain target|Description text} */'
      );
      expect(tokens[0]).toEqual({
        value: '/**',
        scopes: [
      ...
      ({ tokens } = grammar.tokenizeLine(
        '/** Text {@linkcode target Description text} */'
      ));
      expect(tokens[0]).toEqual({
        value: '/**',
        scopes: [
    ...
    it('tokenises tags with a preceding description', function () {
      let { tokens } = grammar.tokenizeLine(
        '/** Text [Description text]{@link target} */'
      );
      expect(tokens[0]).toEqual({
        value: '/**',
        scopes: [
  ...
  describe('block tags', function () {
    ...
    it('tokenises @see tags with {@link} tags', function () {
      ...
      ({ tokens } = grammar.tokenizeLine(
        '/** @see [Description]{@link name#path} */'
      ));
      expect(tokens[0]).toEqual({
        value: '/**',
        scopes: [
    ...
    it('tokenises @param tags with a description', function () {
      ...
      ({ tokens } = grammar.tokenizeLine(
        '/** @arg {object} variable this is the description */'
      ));
      expect(tokens[0]).toEqual({
        value: '/**',
        scopes: [
    ...
    describe('default @param values', function () {
      ...
      it('tokenizes arrays inside object literals', function () {
        ...
        return expect(tokens[38]).toEqual({
          value: '*/',
          scopes: [
            'source.js',
            'comment.block.documentation.js',
    ...
    it('tokenises @param tags with wildcard types', function () {
      let { tokens } = grammar.tokenizeLine(
        '/** @param {*} variable this is the description */'
      );
      expect(tokens[5]).toEqual({
        value: '{',
        scopes: [
    ...
    it('tokenises @return tags with trailing descriptions', function () {
      let { tokens } = grammar.tokenizeLine(
        '/** @returns {object} this is the description */'
      );
      expect(tokens[0]).toEqual({
        value: '/**',
        scopes: [
      ...
      ({ tokens } = grammar.tokenizeLine(
        '/** @return {object} this is the description */'
      ));
      expect(tokens[0]).toEqual({
        value: '/**',
        scopes: [
    ...
    it('tokenises @return tags with multiple types', function () {
      let { tokens } = grammar.tokenizeLine(
        '/** @return {Some|Thing} Something to return */'
      );
      expect(tokens[3]).toEqual({
        value: 'return',
        scopes: [
    ...
    return it('tokenises function-type @return tags', function () {
      let { tokens } = grammar.tokenizeLine(
        '/** @return {function()} this is the description */'
      );
      expect(tokens[2]).toEqual({
        value: '@',
        scopes: [
...
`);
  ...
  return describe('when the line ends without a closing bracket', () =>
