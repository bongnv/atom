...
` +
  ...
  describe('built-in globals', function () {
    ...
    return it('tokenizes built-in variables', function () {
      ...
      expect(tokens[0]).toEqual({
        value: 'module',
        scopes: ['source.js', 'support.variable.js'],
      });
  ...
  describe('regular expressions', function () {
    ...
    it('tokenizes regular expressions inside curly brackets', function () {
      ...
      expect(tokens[0]).toEqual({
        value: '{',
        scopes: ['source.js', 'meta.brace.curly.js'],
      });
      expect(tokens[1]).toEqual({
        value: '/',
        scopes: [
    ...
    it('tokenizes hexadecimals', function () {
      ...
      expect(tokens[1]).toEqual({
        ...
        scopes: [
          ...
          'meta.delimiter.numeric.separator.js',
        ],
      });
...
`);
    ...
    it('tokenizes variables declared with `const` in for-in and for-of loops', function () {
      ...
      expect(tokens[7]).toEqual({
        value: 'of',
        scopes: ['source.js', 'keyword.operator.of.js'],
      });
      ...
      expect(tokens[7]).toEqual({
        value: 'in',
        scopes: ['source.js', 'keyword.operator.in.js'],
      });
    ...
    it('tokenizes support constants', function () {
      ...
      expect(tokens[5]).toEqual({
        value: 'EPSILON',
        scopes: ['source.js', 'support.constant.js'],
      });
  ...
  describe('ES6 tagged Relay.QL string templates with interpolation', () =>
    it('tokenizes them as strings', function () {
      const { tokens } = grammar.tokenizeLine(
        'Relay.QL`fragment on Foo { ${myFragment} }`'
      );
      expect(tokens[0]).toEqual({
        value: 'Relay.QL',
        scopes: [
...
`);
    ...
    it('tokenizes default parameters', function () {
      ...
      ({ tokens } = grammar.tokenizeLine(
        'function callSomething(thing = this.something()) {}'
      ));
      expect(tokens[4]).toEqual({
        value: 'thing',
        scopes: [
...
`);
      ...
      return expect(lines[2][12]).toEqual({
        value: ')',
        scopes: [
          'source.js',
          'meta.method-call.js',
    ...
    return describe('built-in methods', function () {
      ...
      return domMethods.map((domMethod) =>
...
`);
  ...
  describe('console', function () {
    it('tokenizes the console keyword', function () {
      ...
      ({ tokens } = grammar.tokenizeLine('$console'));
      return expect(tokens[1]).not.toEqual({
        value: 'console',
        scopes: ['source.js', 'entity.name.type.object.console.js'],
      });
    });
...
`);
  ...
  describe('ternary expressions', function () {
    ...
    return it('tokenizes arrow functions inside ternary expressions', function () {
      ...
      ({ tokens } = grammar.tokenizeLine(
        'result = condition ? (a, b) => a + b : something'
      ));
      expect(tokens[3]).toEqual({
        value: '?',
        scopes: ['source.js', 'keyword.operator.ternary.js'],
...
`);
  ...
  describe('indentation', function () {
    ...
    const expectPreservedIndentation = function (text) {
      ...
      return actualLines.map((actualLine, i) =>
...
`));
    ...
    return it('indents function arguments', () =>
      expectPreservedIndentation(`\
f(
g( // "
  h,
