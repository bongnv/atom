...
`);
      ...
      return expect(tokens[0][6]).toEqual({
        value: ')',
        scopes: [
          'source.sass',
          'meta.selector.css',
...
.something
  top: 50% - 30%\
`);
      return expect(tokens[1][7]).toEqual({
        value: '-',
        scopes: [
          'source.sass',
          'meta.property-value.sass',
...
.a
  content: "\\abcdef"\
`);
      return expect(tokens[1][5]).toEqual({
        value: '\\abcdef',
        scopes: [
          'source.sass',
          'meta.property-value.sass',
    ...
    it('only tokenizes comments that start at the beginning of a line', function () {
      ...
      expect(tokens[1]).toEqual({
        ...
        scopes: [
          'source.sass',
          'comment.line.sass',
          'punctuation.definition.comment.sass',
        ],
      });
      expect(tokens[2]).toEqual({
        value: 'A comment?',
...
`);
      ...
      return expect(tokens[3][0]).toEqual({
        value: 'hi4',
        scopes: ['source.sass', 'meta.selector.css'],
      });
    });
...
`);
        ...
        expect(tokens[1][7]).toEqual({
          ...
          scopes: [
            'source.sass',
            'meta.property-value.sass',
            'punctuation.section.function.sass',
          ],
        });
        return expect(tokens[1][9]).toEqual({
          value: ')',
          scopes: [
            'source.sass',
            'meta.property-value.sass',
