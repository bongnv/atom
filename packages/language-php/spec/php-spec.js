...
`);
  ...
  describe('functions', function () {
    ...
    it('tokenizes union types in function parameters', function () {
      ...
      ({ tokens } = grammar.tokenizeLine(
        'function test(\\Abc\\ClassA | mixed $a){}'
      ));
    ...
    it('tokenizes intersection types in function parameters', function () {
      const { tokens } = grammar.tokenizeLine(
        'function test(FooInterface&BarInterface $foobar){}'
      );
...
`);
  ...
  describe('numeric literal separator', function () {
    ...
    return it('tokenizes expression', function () {
      let { tokens } = grammar.tokenizeLine(
        '2_0*0_7/(3e-1_3-2_0.3_4)*0b0_1+0Xf*_22'
      );
      ...
      ({ tokens } = grammar.tokenizeLine(
        '_23(1_2)+0_655-[0B0_0,0Xf_8,5.4_8][0b1_0]'
      ));
...
`);
    ...
    it('should tokenize parameter attribute', function () {
      const { tokens } = grammar.tokenizeLine(
        'function Foo(#[ParameterAttribute] $parameter) {}'
      );
...
`);
    ...
    it('should tokenize attribute with arguments', function () {
      const { tokens } = grammar.tokenizeLine(
        '#[Attribute1, Attribute2(true, 2, [3.1, 3.2])]'
      );
...
`);
    ...
    it('should tokenize attribute in anonymous class', function () {
      const { tokens } = grammar.tokenizeLine(
        '$foo = new #[ExampleAttribute] class {};'
      );
...
`);
    ...
    it('should not tokenize /*** as phpdoc', function () {
      ...
      return expect(tokens[0].scopes).not.toContain(
        'comment.block.documentation.phpdoc.php'
      );
    });
    ...
    return runs(function () {
      ...
      return (() => {
        ...
        for (var scope in delimsByScope) {
          ...
          var { tokens } = grammar.tokenizeLine(
