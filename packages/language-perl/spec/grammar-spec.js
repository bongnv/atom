  ...
  describe('when a regexp compile tokenizes', function () {
    ...
    it("does not treat 'm'(hashkey) as a regex match begin", function () {
      ...
      expect(tokens[3]).toEqual({
        ...
        scopes: [
          'source.perl',
          'punctuation.section.brace.curly.bracket.begin.perl',
        ],
      });
      expect(tokens[4]).toEqual({
        value: 'm',
      ...
      return expect(tokens[5]).toEqual({
        ...
        scopes: [
          'source.perl',
          'punctuation.section.brace.curly.bracket.end.perl',
        ],
      });
    });
...
/x`);
    ...
    return it('works in a if', function () {
      ...
      expect(tokens[2]).toEqual({
        ...
        scopes: [
          'source.perl',
          'punctuation.section.parenthesis.round.bracket.begin.perl',
        ],
      });
      expect(tokens[3]).toEqual({
        value: '/',
      ...
      expect(tokens[7]).toEqual({
        ...
        scopes: [
          'source.perl',
          'punctuation.section.parenthesis.round.bracket.end.perl',
        ],
      });
  ...
  describe('when a function call tokenizes', () =>
    it('does not highlight calls which looks like a regexp', function () {
      let { tokens } = grammar.tokenizeLine(
        's_ttest($key,\\"t_storage\\",$single_task);'
      );
      ...
      ({ tokens } = grammar.tokenizeLine(
        's__ttest($key,\\"t_license\\",$single_task);'
      ));
...
`);
      expect(lines[0][0]).toEqual({
        ...
        scopes: [
          'source.perl',
          'meta.function.perl',
          'storage.type.function.sub.perl',
        ],
      });
  ...
  describe('when an operator tokenizes', function () {
    it('highlights assignement operators', function () {
      ...
      expect(tokens[4]).toEqual({
        ...
        scopes: [
          'source.perl',
          'keyword.operator.assignement.conditional.perl',
        ],
      });
      expect(tokens[6]).toEqual({
        value: '//=',
      ...
      expect(tokens[20]).toEqual({
        ...
        scopes: [
          'source.perl',
          'keyword.operator.assignement.compound.bitwise.perl',
        ],
      });
      ...
      expect(tokens[26]).toEqual({
        ...
        scopes: [
          'source.perl',
          'keyword.operator.assignement.compound.stringwise.perl',
        ],
      });
      ...
      return expect(tokens[30]).toEqual({
        value: '^.=',
        scopes: [
          'source.perl',
          'keyword.operator.assignement.compound.stringwise.perl',
...
`);
      ...
      return expect(lines[9][2]).toEqual({
        value: '0',
        scopes: ['source.perl', 'constant.numeric.exponential.perl'],
      });
    });
...
`);
      ...
      expect(lines[4][7]).toEqual({
        ...
        scopes: [
          'source.perl',
          'constant.numeric.decimal.with-thousand-separators.perl',
        ],
      });
      ...
      return expect(lines[8][8]).toEqual({
        value: ';',
        scopes: ['source.perl', 'punctuation.terminator.semicolon.perl'],
      });
    }));
...
`);
      ...
      return expect(lines[8][21]).toEqual({
        value: ';',
        scopes: ['source.perl', 'punctuation.terminator.semicolon.perl'],
      });
    });
  ...
  describe('when package to tokenizes', () =>
    it('does not highlight semicolon in package name', function () {
      const { tokens } = grammar.tokenizeLine(
        'package Test::ASD; #this is my new class'
      );
      expect(tokens[0]).toEqual({
        value: 'package',
      ...
      expect(tokens[1]).toEqual({
        value: ' ',
        scopes: ['source.perl', 'meta.class.perl'],
      });
      expect(tokens[2]).toEqual({
        value: 'Test::ASD',
        scopes: [
...
`);
      ...
      expect(tokens[28]).toEqual({
        ...
        scopes: [
          'source.perl',
          'punctuation.unmatched.parenthesis.round.bracket.end.perl',
        ],
      });

      ({ tokens } = grammar.tokenizeLine(
        'sub name [ a [ b [ c [] 1 ] 2 ] 3 ] ]'
      ));
      expect(tokens[0]).toEqual({
        value: 'sub',
        scopes: [
      ...
      expect(tokens[4]).toEqual({
        ...
        scopes: [
          'source.perl',
          'punctuation.section.square.bracket.begin.perl',
        ],
      });
      expect(tokens[5]).toEqual({ value: ' a ', scopes: ['source.perl'] });
      expect(tokens[6]).toEqual({
      ...
      return expect(tokens[25]).toEqual({
        value: ']',
        scopes: [
          'source.perl',
          'punctuation.unmatched.square.bracket.end.perl',
        ],
      });
    });
...
`);
      ...
      return expect(lines[4][7]).toEqual({
        value: ';',
        scopes: ['source.perl', 'punctuation.terminator.semicolon.perl'],
      });
    });
...
`);
    ...
    it('highlights formatting codes in command parameters', function () {
      const { tokens } = grammar.tokenizeLine(
        '=head1 This is a B<bold heading>'
      );
      expect(tokens[2]).toEqual({
        value: 'This is a ',
        scopes: [
