...
export default class WindowPanelView {
  constructor() {
    ...
    this.disposables.add(
      atom.tooltips.add(this.refs.shellTiming, {
        title: 'The time taken to launch the app',
      })
    );
    this.disposables.add(
      atom.tooltips.add(this.refs.windowTiming, {
  ...
  populate() {
    ...
    if (shellLoadTime != null) {
      this.refs.shellLoadTime.classList.add(
        this.getHighlightClass(shellLoadTime)
      );
